...
Generate a readable GLSL shader based on the shaders in the reflection_environment folder. `.rdc.glsl` is the result of decompiling RenderDoc, and `.usf` is the UE source code. Requirements:
