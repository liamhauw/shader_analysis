...
Generate a readable GLSL shader based on the two shaders in the hzb_4_7 folder. `.rdc.glsl` is the result of decompiling RenderDoc, and `.usf` is the UE source code. Requirements:
